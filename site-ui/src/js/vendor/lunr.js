...
(function () {
  ...
  lunr.FieldRef.fromString = function (s) {
    ...
    if (n === -1) {
      var malformed = 'malformed field ref string'
      throw malformed
    }
  ...
  lunr.Pipeline.warnIfFunctionNotRegistered = function (fn) {
    ...
    if (!isRegistered) {
      lunr.utils.warn('Func not registered with pipeline.may cause problems when serialising the index.\n', fn)
    }
  }
