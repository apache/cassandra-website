...
class CassandraDef(object):
    ...
    stable_version = '3.0.8'
    stable_release_date = '2016-07-05'
    oldstable_version = '2.2.7'
    oldstable_release_date = '2016-07-05'
    veryoldstable_version = '2.1.15'
    veryoldstable_release_date = '2016-07-05'
