...
As we near the release of Apache Cassandra 4.1, we are excited to announce the second annual https://web.archive.org/web/20220716094101/https://www.cassandraworldparty.org/[Apache Cassandra™ World Party^] (CWP) on *Wednesday, July 20, 2022*.
