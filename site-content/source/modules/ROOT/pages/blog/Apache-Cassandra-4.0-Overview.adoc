...
You can download Apache Cassandra, documentation, and ways to become involved with the Apache Cassandra community by visiting {site-url}[https://cassandra.apache.org/] and https://bsky.app/profile/cassandra.apache.org[https://bsky.app/,window=_blank].
