...
--------
[discrete]
image:events/cassandrasummitheader.png[Cassandra Summit 2023]
[discrete]
=== The early bird deadline is fast approaching! Get tickets for Cassandra Summit now!

[.btn.btn--grad]
https://events.linuxfoundation.org/cassandra-summit/register/#register-now[Register now^]
--------
------
----
// end banner
