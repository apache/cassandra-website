...
In anticipation of the release of Cassandra 4.1, we’re excited to announce the second-annual Cassandra World Party, a fun-packed event running across three time zones. Check out the CWP website to register and preview talk topics and times.
...
----------
image::blog/apache-cassandra-world-party-logo.png[link="https://cassandra.apache.org/_/blog/World-Party-2022.html" alt="Apache Cassandra World Party 2022"]
----------
--------
// end row
