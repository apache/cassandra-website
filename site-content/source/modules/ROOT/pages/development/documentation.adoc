...
link:/docs/latest/[cassandra.apache.org].
...
Feel free to take a look at link:/docs/latest/[existing documents] to get a better idea how we structure our documents.
