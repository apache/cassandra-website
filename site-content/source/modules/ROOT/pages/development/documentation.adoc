...
https://cassandra.apache.org/docs/latest/[cassandra.apache.org].
...
Feel free to take a look at https://cassandra.apache.org/doc/latest/[existing documents] to get a better idea how we structure our documents.
