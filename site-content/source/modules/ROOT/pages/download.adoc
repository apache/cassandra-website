...
[.btn.btn--alt]
https://www.apache.org/dyn/closer.lua/cassandra/4.0.4/apache-cassandra-4.0.4-bin.tar.gz[4.0.4,window=blank]

(https://downloads.apache.org/cassandra/4.0.4/apache-cassandra-4.0.4-bin.tar.gz.asc[pgp,window=blank], https://downloads.apache.org/cassandra/4.0.4/apache-cassandra-4.0.4-bin.tar.gz.sha256[sha256,window=blank] and https://downloads.apache.org/cassandra/4.0.4/apache-cassandra-4.0.4-bin.tar.gz.sha512[sha512,window=blank])
----------
