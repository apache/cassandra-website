...
[.btn.btn--alt]
https://www.apache.org/dyn/closer.lua/cassandra/4.1.1/apache-cassandra-4.1.1-bin.tar.gz[4.1.1,window=blank]

(https://downloads.apache.org/cassandra/4.1.1/apache-cassandra-4.1.1-bin.tar.gz.asc[pgp,window=blank], https://downloads.apache.org/cassandra/4.1.1/apache-cassandra-4.1.1-bin.tar.gz.sha256[sha256,window=blank] and https://downloads.apache.org/cassandra/4.1.1/apache-cassandra-4.1.1-bin.tar.gz.sha512[sha512,window=blank])
----------
...
[discrete]
==== Latest release on 2023-04-14
[discrete]
==== Maintained until 5.1.0 release (~July 2024)

[.btn.btn--alt]
https://www.apache.org/dyn/closer.lua/cassandra/4.0.9/apache-cassandra-4.0.9-bin.tar.gz[4.0.9,window=blank]

(https://downloads.apache.org/cassandra/4.0.9/apache-cassandra-4.0.9-bin.tar.gz.asc[pgp,window=blank], https://downloads.apache.org/cassandra/4.0.9/apache-cassandra-4.0.9-bin.tar.gz.sha256[sha256,window=blank] and https://downloads.apache.org/cassandra/4.0.9/apache-cassandra-4.0.9-bin.tar.gz.sha512[sha512,window=blank])
----------
