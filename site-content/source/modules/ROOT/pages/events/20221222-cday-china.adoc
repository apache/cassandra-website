...
China Golden Bridge is dedicated to a harassment-free experience for everyone, in line with the https://www.apache.org/foundation/policies/anti-harassment.html[ASF anti-harassment policy^].
...
中达金桥致力于为每个人提供无骚扰体验，遵循 https://www.apache.org/foundation/policies/anti-harassment.html[ASF 反骚扰政策^]。
