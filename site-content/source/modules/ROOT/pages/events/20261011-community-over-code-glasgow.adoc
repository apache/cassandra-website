...
=== Twenty-two talks over three days
...
Twenty-two sessions, from twenty-nine speakers across a dozen organisations, cover the protocol behind multi-shard transactions and the formal methods used to check it, the storage engine work landing in 6.0, and what it takes to run the database at scale.
...
[#vision-to-reality.cf]
==== 12:00 — From Vision to Reality: Checking In on Cassandra's Future

image:events/speakers/patrick-mcfadin.jpg[Patrick McFadin,110,role=alignleft]
*Patrick McFadin* — McFadin Data and AI Advisory, Inc

A check-in on where Cassandra is heading, organised around four subcommunities doing the work: Operations, DevEx, Performance and Analytics. Covers where momentum is real, where progress is uneven, and what it will take to turn the long-term plan into shipped software.
...
[#terabyte-ingestion]
==== 17:00 — Data Ingestion at Terabyte Scale with Cassandra Analytics
...
[#cqlalchemy.cf]
==== 15:10 — Cassandra 6.0: Introducing CQLAlchemy

image:events/speakers/iroiso-ikpokonte.jpg[Iroiso Ikpokonte,110,role=alignleft]
*Iroiso Ikpokonte* — Founder and CEO, Metropolis Microfinance Bank

CQLAlchemy is a Python toolkit for Cassandra 6.0 modelled on SQLAlchemy. An introduction to the library and to the interface it gives Python applications over CQL.
...
[#cep-60]
==== 17:50 — CEP-60: Flexible Placements

*Tejal Chakeres* — Apple +
*Abhijeet Dubey* — Apple

{cep}/CEP-60%3A+Flexible+Placements[CEP-60^] builds on Transactional Cluster Metadata. Once ownership changes are linearizable metadata operations, bootstrap, decommission and movement need no longer be large all-or-nothing workflows; ownership can instead move in smaller resumable steps. Combined with range-aware compaction and zero-copy streaming, this shortens over-replication windows and makes topology changes more predictable.
...
[#cep-57.cf]
==== 11:10 — Solving tombstones and partitioning with flat keys and tries (CEP-57)
...
[#four-to-five]
==== 12:00 — Much Ado About Nothing: Making Cassandra 4→5 Upgrades Predictable and Low-Risk
...
[#zstd-dictionary]
==== 14:20 — Zstd dictionary compression
...
[#zero-trust-mtls.cf]
==== 15:10 — Running Apache Cassandra in a Zero Trust Environment with Mutual TLS
...
[#cep-38.cf]
==== 16:10 — CEP-38: The Management Port Decision: A Live Architecture Trade-off in Apache Cassandra
...
[#cep-59.cf]
==== 17:00 — CEP-59: Graceful Disconnect — Draining Client Connections During Cassandra Node Shutdown
